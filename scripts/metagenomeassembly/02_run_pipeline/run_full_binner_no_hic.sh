...
#SBATCH --mem=500G
#SBATCH --job-name=metaasm_full_binners_no_hic
#SBATCH --output=logs/metaasm_full_binners_no_hic_%j.out
#SBATCH --error=logs/metaasm_full_binners_no_hic_%j.err
