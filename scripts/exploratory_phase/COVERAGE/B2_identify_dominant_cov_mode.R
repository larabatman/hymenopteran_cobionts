...
# Estimate hos coverage center: largest fraction of the assembled DNA is host, 
# and the median coverage across contigs is assumed host
...
# Measure spread: Median Absolute Deviation, an outlier-robust version 
...
# an extreme case is added when the absolut difference is higher than 6 MADs
# direction cases are for being above and below host MAD
gc_cov <- gc_cov %>%
    mutate(
